...
import { Search, Rocket, Pause, Play, ArrowRight, User, GraduationCap, DollarSign, Filter, Activity, CheckCircle2, AlertCircle } from 'lucide-react';
                ...
                <div className="max-w-6xl">
                    <div className="flex justify-between items-start mb-12">
                        <div>
                            ...
                            <h1 className="text-5xl font-heading font-bold mb-4">Agentic Scholarship Hub</h1>
                            <p className="text-gray-500 font-medium max-w-xl leading-relaxed">Your autonomous education agents are scanning 4,200+ global funding opportunities to match your academic profile.</p>
                        </div>
                        ...
                        <div className="col-span-12 lg:col-span-7 flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                {isLoading ? (
                                    ...
                                    scanResults?.recommendations?.map((item: any, i: number) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-xs text-gray-500 font-medium mb-6 line-clamp-2 leading-relaxed">Exclusive funding for students demonstrating top percentile academic performance.</p>
                                ...
                                <div className="bg-[#E9F0E6] rounded-[2rem] p-6 border border-white border-dashed flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white/50 transition-all">
                                    ...
                                    <p className="text-xs text-gray-500 font-medium max-w-[150px]">Update your agent parameters to find more matches.</p>
                                </div>
                            </div>
                        </div>
                    </div>
